...
#===============================================================================
f=open('n1.txt','w')
f.write("Hello This is Arun Silawat\n I am from Bhopal")
#f.writelines()
f.writable()
data=('This is Python Class','Timing 1,30')
f.close()

f=open('n2.txt','w')
f.write("Hello I am Arun")
f.writelines("hjhshs shhui suhq qshh  h qsuh  uh qjqs  u q\nqwuiqwiqwuhqi qqhsiqh sqsh \nhqwduqiuq qqi")
